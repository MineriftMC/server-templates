...
MINERIFT_INSTALL_VIA="${MINERIFT_INSTALL_VIA:-true}"
...
if paper_global_path.exists():
    lines = paper_global_path.read_text(encoding="utf-8", errors="ignore").splitlines()
    proxy_block = [
        "proxies:",
        "  bungee-cord:",
        "    online-mode: true",
